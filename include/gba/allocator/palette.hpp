...
public:
    ...
    [[nodiscard]]
    constexpr uint32 bank() const noexcept {
        return m_shift;
    }
...
public:
    ...
    constexpr void deallocate( palette_buffer& block ) noexcept {
        m_bitset &= ~block.mask();
        block = nullptr;
    }

#ifndef GBAXX_IO_MODE4_HPP
#define GBAXX_IO_MODE4_HPP
...
struct mode<4> {
    ...
    static_assert( sizeof( display_control ) == 2, "mode<4>::display_control must be tightly packed" );
...
#endif // define GBAXX_IO_MODE4_HPP
